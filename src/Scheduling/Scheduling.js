...
function createData(si, coursename,teachername, starttiming,lasttiming,  status ) {
  return { si, coursename,teachername, starttiming,lasttiming,status, action: (
      <>
...
const rows = [
  createData('1', 'Full stack','Ravish', '10:30am','3:00pm', 'Active')
