...
const AllStudents = () => {
    ...
    const columns = [
        ...
        { id: 'mobile_number', label: 'Mobile Number ', flex: 1, align: 'center', },

        { id: 'email_id', label: 'Email Id ', flex: 1, align: 'center', },

        { id: 'dob', label: 'DOB ', flex: 1, align: 'center', },

        { id: 'address', label: 'Address ', flex: 1, align: 'center', },

        { id: 'enrollment_date', label: 'Enrollment Date ', flex: 1, align: 'center', },
    ...
    function createData(si, student_name, gender, mobile_number, email_id, dob, address, enrollment_date, course, status,) {
        return {
            si, student_name, gender, mobile_number, email_id, dob, address, enrollment_date, course, status, action: (
                <>
    ...
    const rows = [
        createData('1', 'Nandini', 'Female', '3464789023', 'kumarinandini07@gmail.com', '03-05-2003','Jamshedpur','28-04-25','Full Stack', 'Completed')
    ...
    return (
        ...
        <Box className="container">
            ...
            <CommonDialog
                ...
                onClose={handleClose}
                dialogTitle={<>
                    {openData ? "Create New Student List" : viewData ? "View Student Details" : editData ? "Edit Student Details" : deleteData ? "Delete Student Details" : null}
                </>}
