...
function createData(si, coursename, description, duration, paymentfee, status, ) {
    return { si, coursename, description, duration, paymentfee, status, action: (
      <>
...
const rows = [
     createData('1', 'Web', 'BestCourse', '6 months', '5000', 'Active'),
